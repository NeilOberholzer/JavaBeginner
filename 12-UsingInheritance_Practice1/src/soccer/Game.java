...
//                System.out.println(i);
                Goal currEveant = new Goal();
                currEveant.setTheTeam(Math.random() > 0.5 ? homeTeam : awayTeam);
                currEveant.setThePlayer(currEveant.getTheTeam().
                        getPlayerArray()[(int) (Math.random() *
                                currEveant.getTheTeam().getPlayerArray().length)]);
                
                currEveant.setTheTime(i);
                
                eventList.add(currEveant);
